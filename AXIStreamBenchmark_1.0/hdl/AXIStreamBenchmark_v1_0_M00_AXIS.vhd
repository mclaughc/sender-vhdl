...
entity AXIStreamBenchmark_v1_0_M00_AXIS is
	generic (
	...
	port (
        ...
        LAST_VALUE : out std_logic_vector(C_M_AXIS_TDATA_WIDTH-1 downto 0)
	);
end AXIStreamBenchmark_v1_0_M00_AXIS;

architecture implementation of AXIStreamBenchmark_v1_0_M00_AXIS is
    ...
    signal last_value_reg : std_logic_vector(C_M_AXIS_TDATA_WIDTH-1 downto 0);
    constant INCREMENT : integer := (C_M_AXIS_TDATA_WIDTH/8);
	  ...
	  begin                                                                         
	    if (rising_edge (M_AXIS_ACLK)) then                                         
	      if(M_AXIS_ARESETN = '0') then                                             
	        ...
	        last_value_reg <= stream_data_out;
	      end if;                                                                   
	     end if;                                                                    
	   end process;                                                                 
